...
st.set_page_config(
    ...
    layout="wide", 
    page_icon="🛡️",
    initial_sidebar_state="expanded" # Obliga a que el menú arranque abierto
)

# --- CSS DE ALTA PRECISIÓN: ELIMINA GITHUB PERO PROTEGE EL MENÚ ---
st.markdown("""
    <style>
    /* 1. Ocultamos los botones de la derecha (GitHub, Share, Deploy) */
    [data-testid="stToolbar"], [data-testid="stDecoration"], .stAppDeployButton {
        display: none !important;
    }
    
    /* 2. PROTECCIÓN DEL BOTÓN DE MENÚ (La Hamburguesa) */
    /* Aseguramos que el área del header sea transparente pero permita clicks */
    header {
        background-color: rgba(0,0,0,0) !important;
    }

    /* Forzamos que el control del menú sea visible, blanco y esté "arriba" de todo */
    ...
    /* Forzamos el color del icono dentro del botón */
...
if check_password():
    ...
    # --- VISTA: CONSULTORIA ---
        ...
        st.title("Métricas Sergio (Priorización)")
